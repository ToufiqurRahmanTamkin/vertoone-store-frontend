...
import { FaArrowRight, FaShoppingBag, FaTruck, FaLock, FaHeadset } from 'react-icons/fa';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-28">
          <div className="max-w-2xl">
            ...
            <p className="text-blue-100 text-lg mb-8 leading-relaxed">
              Discover thousands of products across all categories. Quality guaranteed with fast delivery right to your door.
            </p>
      ...
      {categories.length > 0 && (
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
          <div className="flex items-center justify-between mb-8">
            ...
            <Link to="/products" className="text-blue-600 hover:text-blue-700 font-medium text-sm flex items-center gap-1">
      ...
      <section className="bg-blue-600">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 text-center">
          ...
          <form onSubmit={handleNewsletterSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
            ...
            />
            <button type="submit" className="px-6 py-3 bg-white text-blue-700 font-bold rounded-xl hover:bg-blue-50 transition shadow whitespace-nowrap">
              Subscribe
            </button>
          </form>
        </div>
